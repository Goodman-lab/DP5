...
def AssignCarbon(NMRData,Isomers,settings):
    ...
    for isomer in Isomers:
        ...
        assigned_shifts, assigned_peaks, assigned_labels, scaled_shifts = iterative_assignment(NMRData.carbondata["exppeaks"],
                                                                                               ...
                                                                                               isomer.Cshifts, isomer.Clabels,settings)
...
def iterative_assignment(picked_peaks, spectral_xdata_ppm, total_spectral_ydata, calculated_shifts, C_labels,settings):
    ...
    while lnum < 2:
        ...
        pos_matrix = carbon_probabilities(diff_matrix, settings)
        ...
        for v, h in zip(vertical_ind, horizontal_ind):
            ...
            if len(w) > 0:
                ...
                ratio = (max_window_amp / assigned_amp) * 10
...
def carbon_probabilities(diff_matrix, settings):
    # unscaled error data
    ...
    if settings.StatsParamFile != 'none':
        ...
        scaled_mu, scaled_std, Hmeans, Cmeans = ReadParamFile(settings.StatsParamFile, 'm')
